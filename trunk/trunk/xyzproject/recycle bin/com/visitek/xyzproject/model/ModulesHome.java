 ...
 * @see com.visitek.xyzproject.model.Modules
 * @author Hibernate Tools
 */
public class ModulesHome {

    private static final Log log = LogFactory.getLog(ModulesHome.class);
    ...
    public void persist(Modules transientInstance) {
        log.debug("persisting Modules instance");
        try {
    ...
    public Modules findById( java.lang.Long id) {
        log.debug("getting Modules instance with id: " + id);
        try {
            Modules instance = (Modules) sessionFactory.getCurrentSession()
                    .get("com.visitek.xyzproject.model.Modules", id);
            if (instance==null) {
    ...
    public List<Modules> findByExample(Modules instance) {
        log.debug("finding Modules instance by example");
        try {
            List<Modules> results = (List<Modules>) sessionFactory.getCurrentSession()
                    .createCriteria("com.visitek.xyzproject.model.Modules")
                    .add( create(instance) )
            .list();
