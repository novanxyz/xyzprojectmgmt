...
/**
 * Home object for domain model class Tasks.
 * @see com.visitek.xyzproject.model.Tasks
 * @author Hibernate Tools
 */
public class TasksHome {

    private static final Log log = LogFactory.getLog(TasksHome.class);
    ...
    public void persist(Tasks transientInstance) {
        log.debug("persisting Tasks instance");
        try {
    ...
    public Tasks merge(Tasks detachedInstance) {
        ...
        try {
            Tasks result = (Tasks) sessionFactory.getCurrentSession()
    ...
    public Tasks findById( java.lang.Long id) {
        log.debug("getting Tasks instance with id: " + id);
        try {
            Tasks instance = (Tasks) sessionFactory.getCurrentSession()
                    .get("com.visitek.xyzproject.model.Tasks", id);
            if (instance==null) {
    ...
    public List<Tasks> findByExample(Tasks instance) {
        ...
        try {
            List<Tasks> results = (List<Tasks>) sessionFactory.getCurrentSession()
                    .createCriteria("com.visitek.xyzproject.model.Tasks")
                    .add( create(instance) )
            .list();
