 ...
 * @see com.visitek.xyzproject.model.Session
...
public class SessionHome {
    ...
    public Session merge(Session detachedInstance) {
        ...
        try {
            Session result = (Session) sessionFactory.getCurrentSession()
    ...
    public Session findById( java.lang.Long id) {
        ...
        try {
            Session instance = (Session) sessionFactory.getCurrentSession()
                    .get("com.visitek.xyzproject.model.Session", id);
            if (instance==null) {
    ...
    public List<Session> findByExample(Session instance) {
        ...
        try {
            List<Session> results = (List<Session>) sessionFactory.getCurrentSession()
                    .createCriteria("com.visitek.xyzproject.model.Session")
                    .add( create(instance) )
            .list();
