 ...
 * @see com.visitek.xyzproject.model.Projects
...
public class ProjectsHome {
    ...
    public Projects merge(Projects detachedInstance) {
        ...
        try {
            Projects result = (Projects) sessionFactory.getCurrentSession()
    ...
    public Projects findById( java.lang.Long id) {
        log.debug("getting Projects instance with id: " + id);
        try {
            Projects instance = (Projects) sessionFactory.getCurrentSession()
                    .get("com.visitek.xyzproject.model.Projects", id);
            if (instance==null) {
    ...
    public List<Projects> findByExample(Projects instance) {
        log.debug("finding Projects instance by example");
        try {
            List<Projects> results = (List<Projects>) sessionFactory.getCurrentSession()
                    .createCriteria("com.visitek.xyzproject.model.Projects")
                    .add( create(instance) )
            .list();
