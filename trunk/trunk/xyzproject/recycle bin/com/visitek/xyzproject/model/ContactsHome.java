 ...
 * @see com.visitek.xyzproject.model.Contacts
...
public class ContactsHome {
    ...
    public List<Contacts> findByExample(Contacts instance) {
        ...
        try {
            List<Contacts> results = (List<Contacts>) sessionFactory.getCurrentSession()
                    .createCriteria("com.visitek.xyzproject.model.Contacts")
                    .add( create(instance) )
            .list();
