...
import com.visitek.xyzproject.ejb.UserLocalService;
import com.visitek.xyzproject.ejb.UserRemoteService;
...
public class UserService extends BaseService<User> implements UserLocalService, UserRemoteService{
	...
	public User createUserfromContact(Contact contact, String password) {
		...
		String username = contact.getEmail().substring(0, contact.getEmail().indexOf('@'));
		return newUser(username,contact.getEmail(),password,contact);
