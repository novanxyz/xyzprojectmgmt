...
public class XYZNamingStrategy implements NamingStrategy {
	...
	public String classToTableName(String arg0) {
		...
		if (arg0.endsWith("s") || arg0.endsWith("sh") || arg0.endsWith("ch")
				|| arg0.endsWith("o") || arg0.endsWith("z"))
			return arg0 + "es";
		if (arg0.endsWith("y"))
			return arg0.substring(0, arg0.length() - 1) + "ies";
		return arg0 + 's';
	...
	public String tableToClassName(String tab) {
		...
		if (tab.endsWith("ies"))
			return tab.substring(0, tab.length() - 3) + "y";
